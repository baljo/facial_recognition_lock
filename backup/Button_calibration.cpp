...
void setup() {
    ...
    //person_sensor_write_reg(PERSON_SENSOR_REG_ERASE_IDS,0x0);
    ...
    for (int i = 0; i < results.num_faces; ++i) {
        ...
        for (int j = 0; j < MAX_FACES; ++j) {
            ...
            if (faceIDs[j] == face->id) {
                ...
                // Serial.print("Recognition ID: ");
                // Serial.print("faceIDs[j] = " + String(faceIDs[j]) + " ");
